  ...
  <form action="register.php" method="post">
	<div class="box-form">
		...
		<div class="register-title">
			Register
			<div class="fill">Please fill in this form to create an account.
		...
		<!--terms and privacy-->
		<div class="terms">
			<p style= "resize: both;">By creating an account you agree to our <span class= "tnp"><a href="#">Terms & Privacy.</a></span></p>
		</div>
		...
		<div class="acc">
			<p>Already have an account? <span class= "sign-in"><a href="login.php">Sign In</a></span></p>
		</div>
